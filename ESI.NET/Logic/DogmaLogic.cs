...
namespace ESI.NET.Logic
{
    public class DogmaLogic
    {
        ...
        /// <returns></returns>
        public async Task<EsiResponse<AttributeInfo>> Attribute(long attribute_id, EsiCallOptions options = null)
        ...
        /// <returns></returns>
        public async Task<EsiResponse<EffectInfo>> Effect(long effect_id, EsiCallOptions options = null)
        ...
        /// <returns></returns>
        public async Task<EsiResponse<DynamicItem>> DynamicItem(long type_id, long item_id, EsiCallOptions options = null)
