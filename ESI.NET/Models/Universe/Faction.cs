...
namespace ESI.NET.Models.Universe
{
    public class Faction
    {
        ...
        [JsonProperty("size_factor")] public decimal SizeFactor { get; set; }

        [JsonProperty("station_count")] public int StationCount { get; set; }

        [JsonProperty("station_system_count")] public int StationSystemCount { get; set; }

        [JsonProperty("is_unique")] public bool IsUnique { get; set; }
    }
}