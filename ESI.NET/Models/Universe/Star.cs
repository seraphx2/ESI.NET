...
namespace ESI.NET.Models.Universe
{
    public class Star
    {
        ...
        [JsonProperty("luminosity")] public decimal Luminosity { get; set; }

        [JsonProperty("radius")] public long Radius { get; set; }

        [JsonProperty("spectral_class")] public string SpectralClass { get; set; }
