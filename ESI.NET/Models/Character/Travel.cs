...
namespace ESI.NET.Models.Character
{
    public class Travel
    {
        ...
        [JsonProperty("align_to")] public long AlignTo { get; set; }
        ...
        [JsonProperty("docks_high_sec")] public long DocksHighSec { get; set; }

        [JsonProperty("docks_low_sec")] public long DocksLowSec { get; set; }

        [JsonProperty("docks_null_sec")] public long DocksNullSec { get; set; }
        ...
        [JsonProperty("jumps_wormhole")] public long JumpsWormhole { get; set; }

        [JsonProperty("warps_high_sec")] public long WarpsHighSec { get; set; }

        [JsonProperty("warps_low_sec")] public long WarpsLowSec { get; set; }

        [JsonProperty("warps_null_sec")] public long WarpsNullSec { get; set; }

        [JsonProperty("warps_to_bookmark")] public long WarpsToBookmark { get; set; }

        [JsonProperty("warps_to_celestial")] public long WarpsToCelestial { get; set; }

        [JsonProperty("warps_to_fleet_member")]
        public long WarpsToFleetMember { get; set; }

        [JsonProperty("warps_to_scan_result")] public long WarpsToScanResult { get; set; }

        [JsonProperty("warps_wormhole")] public long WarpsWormhole { get; set; }
    }
}