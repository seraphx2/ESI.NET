...
namespace ESI.NET.Models.Character
{
    public class Market
    {
        ...
        [JsonProperty("buy_orders_placed")] public long BuyOrdersPlaced { get; set; }

        [JsonProperty("cancel_market_order")] public long CancelMarketOrder { get; set; }
        ...
        [JsonProperty("isk_gained")] public long IskGained { get; set; }

        [JsonProperty("isk_spent")] public long IskSpent { get; set; }

        [JsonProperty("modify_market_order")] public long ModifyMarketOrder { get; set; }

        [JsonProperty("search_contracts")] public long SearchContracts { get; set; }

        [JsonProperty("sell_orders_placed")] public long SellOrdersPlaced { get; set; }
    }
}