...
namespace ESI.NET.Models.Corporation
{
    public class CharacterRolesHistory
    {
        ...
        [JsonProperty("new_roles")] public string[] NewRoles { get; set; }

        [JsonProperty("old_roles")] public string[] OldRoles { get; set; }

        [JsonProperty("role_type")] public string RoleType { get; set; }
    }
}