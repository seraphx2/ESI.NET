...
namespace ESI.NET.Models.Corporation
{
    public class Outpost
    {
        ...
        [JsonProperty("office_rental_cost")] public long OfficeRentalCost { get; set; }
        ...
        [JsonProperty("standing_owner_id")] public int StandingOwnerId { get; set; }

        [JsonProperty("coordinates")] public Position Coordinates { get; set; }

        [JsonProperty("services")] public List<OutpostService> Services { get; set; } = new List<OutpostService>();
    }
    ...
    public class OutpostService
    {
        ...
        [JsonProperty("minimum_standing")] public decimal MinimumStanding { get; set; }
