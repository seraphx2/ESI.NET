...
namespace ESI.NET.Models.Corporation
{
    public class Corporation
    {
        ...
        [JsonProperty("ceo_id")] public int CeoId { get; set; }
        ...
        [JsonProperty("home_station_id")] public int HomeStationId { get; set; }
        ...
        [JsonProperty("war_eligible")] public bool WarEligible { get; set; }
    }
}