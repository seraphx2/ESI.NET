...
namespace ESI.NET.Models.Sovereignty
{
    ...
    {
        [JsonProperty("attackers_score")] public double AttackersScore { get; set; }
        ...
        [JsonProperty("defender_score")] public double DefenderScore { get; set; }

        [JsonProperty("event_type")] public string EventType { get; set; }

        [JsonProperty("participants")] public List<Participants> Participants { get; set; } = new List<Participants>();
